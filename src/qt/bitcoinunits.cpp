...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("MatrixCoins"));
    case mBTC: return QString(QObject::tr("Milli-MatrixCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-MatrixCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
